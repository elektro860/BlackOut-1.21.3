...
public class Fog extends BlackOutModule {
        ...
        public void modifyFog() {
                RenderSystem.setShaderFog(new net.minecraft.client.render.Fog((float) (distance.get() * 1f),
                                (float) (distance.get() + fading.get()), shape.get(), color.get().r,
                                color.get().g, color.get().b,
                                color.get().a / (float) ((100 - thickness.get()) * 2.55f)));
        }
}
