...
public class CatGirl extends HudElement {
    ...
    public static final HudElementInfo<CatGirl> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "catgirl",
            "It's a Cat girl what do you want", CatGirl::new);
    ...
    public void render(HudRenderer renderer) {
        ...
        Renderer2D.TEXTURE.texQuad(x + (side.get() == SideMode.Left ? girlScale.get() * 450 : 0), y,
                girlScale.get() * (side.get() == SideMode.Left ? girlScale.get() * -450 : 450), girlScale.get() * 755,
