...
import kassuk.addon.blackout.globalsettings.RaytraceSettings;
import kassuk.addon.blackout.globalsettings.RotationSettings;
import kassuk.addon.blackout.globalsettings.ServerSettings;
...
public class SettingUtils {
    ...
    public static final RaytraceSettings raytrace = Modules.get().get(RaytraceSettings.class);
    public static final RotationSettings rotation = Modules.get().get(RotationSettings.class);
    public static final ServerSettings server = Modules.get().get(ServerSettings.class);
    public static final SwingSettings swing = Modules.get().get(SwingSettings.class);
    ...
    public static PlaceData getPlaceDataAND(BlockPos pos, Predicate<Direction> predicateDir,
    ...
    public static PlaceData getPlaceDataAND(BlockPos pos, Predicate<Direction> predicateDir,
            Predicate<BlockPos> predicate, boolean ignoreContainers) {
